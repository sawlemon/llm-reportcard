...
| Cost / efficiency | | very token-hungry; ChatGPT Go monthly limit depleted in days; OpenAI models generally pricier than others on OpenRouter; ChatGPT Plus subscription usage is terrible now — the 5-hour and weekly limits get burned through even on simple tasks like insurance research, draining much faster than it used to |
